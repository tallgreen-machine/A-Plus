...
export const KpiCard: React.FC<KpiCardProps> = ({ title, value, icon, change, changeType }) => {
    ...
    return (
        <div className="bg-brand-surface p-4 rounded-lg border border-brand-border flex-1 transition-all duration-300 ease-in-out hover:shadow-md hover:-translate-y-1">
