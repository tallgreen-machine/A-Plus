...
def main():
    ...
    try:
        ...
        while True:
            # Portfolio logging is now handled within ExecutionCore or a dedicated monitoring module
            # based on FillEvents. The direct portfolio object is no longer passed around here.
